          ...
          <CardContent>
            ...
            <div className="mt-6 text-center">
              <button
                ...
                className="px-4 py-2 text-sm font-medium bg-gradient-to-r from-indigo-500 to-blue-600 text-white rounded-md hover:from-indigo-600 hover:to-blue-700 transition-all duration-200"
              >
